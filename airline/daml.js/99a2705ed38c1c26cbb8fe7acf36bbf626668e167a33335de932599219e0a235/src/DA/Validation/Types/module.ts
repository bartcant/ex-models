...
export const Validation = <errs, a>(errs: daml.Serializable<errs>, a: daml.Serializable<a>): daml.Serializable<Validation<errs, a>> => ({
  decoder: () => jtv.oneOf<Validation<errs, a>>(
    jtv.object({tag: jtv.constant('Errors'), value: jtv.lazy(() => pkge22bce619ae24ca3b8e6519281cb5a33b64b3190cc763248b4c3f9ad5087a92c.DA.NonEmpty.Types.NonEmpty(errs).decoder())}),
